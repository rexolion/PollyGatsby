...
import CartModalMobile from './CartModalMobile/cartModalMobile';
import './cart.css';
	...
	render() { 
		...
		return ( 
			<div className="Cart Header-button" onClick={this.toogleModal}>
				...
				{isMobile() ? <CartModalMobile inCart={inCart} open={this.state.cartClicked} onClose={this.toogleModal}/> : <CartModal inCart={inCart} open={this.state.cartClicked} onClose={this.toogleModal}/>
				}
			</div>
