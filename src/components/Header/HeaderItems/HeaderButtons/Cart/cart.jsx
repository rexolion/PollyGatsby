...
const CartSVG = () => {
	return (<svg  className="Icon-cart"version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		viewBox="0 0 612.322 612.322" styles="enable-background:new 0 0 612.322 612.322;" xmlSpace="preserve">
		<g>
			<g>
				<g>
