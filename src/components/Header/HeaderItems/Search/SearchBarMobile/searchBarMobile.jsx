...
import SearchBarMobileInput from './SearchBarMobileInput/searchBarMobileInput';
...
class SearchBarMobile extends React.Component {
	...
	handleSearch = () => {
		this.props.handleSearchIconPressed();
		this.setState(prev => ({searchClicked: !prev.searchClicked}));
	}

	render() { 
		return ( 
			<form className="Search-container">
				{this.state.searchClicked && <SearchBarMobileInput searchHandler={this.props.searchHandler} searchValue={this.props.searchValue}/>}
				<div className="Icon_search"  onClick={this.handleSearch} >
					<SearchSVG/>
				</div>
			</form>
		);
